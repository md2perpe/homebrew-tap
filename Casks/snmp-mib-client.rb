cask "snmp-mib-client" do
  ...
  url "https://github.com/md2perpe/bryllun/releases/download/v#{version}/SNMP.MIB.Client_#{version}_#{arch}.dmg"
  name "SNMP MIB Client"
  desc "Renamed to Bryllun — install the bryllun cask instead"
  homepage "https://github.com/md2perpe/bryllun"

  disable! date: "2026-09-15", because: "was renamed to bryllun", replacement_cask: "bryllun"
